          ...
          <div className="grid-container">
            <div className="featured grid-one">
              <Link to="categories/furnitures">
                ...
                <p className="main-description">Vive cómodamente</p>
              </Link>
            </div>
            <div className="featured grid-two">
              <Link to="categories/skin-care">
                ...
                <p className="main-description">Protección de la piel</p>
              </Link>
            </div>
            <div className="featured grid-four">
              <Link to="categories/kitchen">
                ...
                <p className="main-description">Cocina</p>
              </Link>
            </div>
            <div className="featured grid-four-low">
              <Link to="categories/electronics">
                ...
                <p className="main-description">Tecnología</p>
              </Link>
            </div>
          </div>
        </div>
